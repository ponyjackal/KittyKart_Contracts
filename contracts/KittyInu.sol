...
contract KittyInu is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, ERC20Upgradeable {
  /**
   * @dev initializer for KittyInu creation
   */
  function initialize() external initializer {
    __Context_init();
    __Ownable_init();
    __ReentrancyGuard_init();
    __ERC20_init("KittyInu", "KITTYINU");
  }
